...
| username       | credentials| Required: Account username.
| password       | credentials| Required: Account password.
| channelId      | credentials| Required: Channel ID to snapshot.
| apiAgent       | String     | Required: gamexAPIAgent - see README for more info.
...
| placedDateStart| String     | Specify a start date for the list of bets to be returned. Foramt: `yyyy-MM-dd-HH:mm`
| placedDateEnd  | String     | Specify an end date for the list of bets to be returned. Foramt: `yyyy-MM-dd-HH:mm`
